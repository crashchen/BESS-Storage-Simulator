...
Resize still re-fits on any canvas size change. With h-dvh, mobile browser chrome can therefore reset a manually inspected camera view; the mechanism is confirmed, its real-phone frequency is not. Preserving user views on resize is separate follow-up scope. This batch is committed locally, not pushed or deployed; production stays be9eb17. See `docs/audits/2026-09-20/cc-review.md` for the reviewer/runtime/browser evidence boundary.
