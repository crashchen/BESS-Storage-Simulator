...
The [batch 10 candidate](docs/audits/2026-09-24/batch-10.md) displays the peak-tariff threshold calculated by the same AUTO policy function in Controls. It is a tariff-only estimate, with an explicit warning when the threshold cannot be reached within the UI's price range. This branch awaits review and has not been released.
