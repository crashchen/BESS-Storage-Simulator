...
Batch 8's auditable discharge-value split was released through [PR #12](https://github.com/crashchen/BESS-Storage-Simulator/pull/12) as `20dadaf`; its main CI and Pages deployment passed. Node 24.21.0 lint, 230 tests across 21 files, and the Pages-path build passed after the user-arranged CC review and follow-up. The live Metrics breakdown and negative-price wording were checked without browser errors. [Batch 8 evidence](docs/audits/2026-09-23/batch-8.md) distinguishes actual avoided imports from the assumed value of restored load. Batch 9's evening-peak AUTO change is on `codex/audit-batch-9-peak-priority`: the user-arranged CC first review found a loose price gate, and the follow-up now accounts for efficiency, peak-pacing residual and reserve value. The revised candidate awaits follow-up review and release; see the [batch 9 record](docs/audits/2026-09-23/batch-9.md).
